    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div
            className={`relative bg-gradient-to-br from-green-50 to-white rounded-3xl p-8 border-2 border-green-200 hover:border-green-400 transition-all hover:shadow-xl ${
              isVisible ? "animate-fade-in-up" : "opacity-0"
            }`}
          ...
          <div
            className={`relative bg-gradient-to-br from-blue-50 to-white rounded-3xl p-8 border-2 border-blue-200 hover:border-blue-400 transition-all hover:shadow-xl ${
              isVisible ? "animate-fade-in-up" : "opacity-0"
            }`}
