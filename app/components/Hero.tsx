...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center pt-32 sm:pt-28 lg:pt-20 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-green-50/50 to-white overflow-hidden">
