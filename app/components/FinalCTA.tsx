          ...
          <div className="mt-10 flex justify-center items-center gap-4">
            <div className="flex -space-x-3">
              <div className="w-10 h-10 rounded-full border-2 border-white overflow-hidden relative">
                <Image src="/student-focused.png" alt="Student" fill className="object-cover" />
              </div>
              <div className="w-10 h-10 rounded-full border-2 border-white overflow-hidden relative">
                <Image src="/cafe-learning.png" alt="Student" fill className="object-cover" />
              </div>
              <div className="w-10 h-10 rounded-full border-2 border-white overflow-hidden relative">
                <Image src="/learning-setup.png" alt="Student" fill className="object-cover" />
              </div>
            </div>
